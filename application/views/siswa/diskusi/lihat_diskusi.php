<div class="container-fluid py-4">
    <div class="row">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a href="<?= base_url() ?>discussion" class="text-primary fw-bold">Diskusi</a></li>
    ...
    <div class="row mx-0">
        <div class="card">
            <div class="card-body p-0 py-2">
                <a href="<?= base_url() ?>discussion/all/<?= $course_id ?>" class="btn btn-disabled mb-0 course-menu shadow-none  <?php if ($title == "Semua Topik") {
                                                                                                                                        echo "active-menu";
                                                                                                                                    } ?>">Semua</a>
                <a href="<?= base_url() ?>discussion/topik/Pengumuman/<?= $course_id ?>" class="btn btn-disabled mb-0 course-menu shadow-none  <?php if ($title == "Pengumuman") {
                                                                                                                                                    echo "active-menu";
                                                                                                                                                } ?>">Pengumuman</a>
                <a href="<?= base_url() ?>discussion/topik/Tugas/<?= $course_id ?>" class="btn btn-disabled mb-0 course-menu shadow-none  <?php if ($title == "Tugas") {
                                                                                                                                                echo "active-menu";
                                                                                                                                            } ?>">Tugas</a>
                <a href="<?= base_url() ?>discussion/topik/Pertanyaan/<?= $course_id ?>" class="btn btn-disabled mb-0 course-menu shadow-none  <?php if ($title == "Pertanyaan") {
                                                                                                                                                    echo "active-menu";
                                                                                                                                                } ?>">Pertanyaan</a>
            </div>
        </div>
