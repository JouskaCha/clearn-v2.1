<div class="container-fluid py-4">
    ...
    <p class="fw-bold text-dark small mt-4 text-uppercase"> <i class="fas fa-dot-circle text-warning me-1"></i>REKAP NILAI QUIZ  <?=$quiz->QuizTitle?></p>
    <div class="row mx-0 ">
        <?php if(!empty($siswa)):?>
        <div class="card mt-3">
                ...
                <table class="table table-hover mt-3" id="daftar_siswa">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?=base_url()?>guru/answer/<?=$quiz->QuizID?>/<?=$course->CourseID?>/<?=$row->UserID?>" class="btn btn-warning btn-sm">Lihat jawaban</a></tr>
                        </tr>
                        <?php $x++; endforeach;?>
                    </tbody>
                </table>
